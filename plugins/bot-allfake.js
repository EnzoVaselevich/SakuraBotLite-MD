...
global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363263466636910@newsletter', serverMessageId: '', newsletterName: '✰્᭄͜͡ 𝐒𝐚𝐤𝐮𝐫𝐚 𝐁𝐨𝐭 𝐋𝐢𝐭𝐞 - 𝐌𝐃 💖' }, externalAdReply: { title: wm, body: `👋 Hola ` + nombre, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: sakuraImg, thumbnail: sakuraImg, sourceUrl: md }}}, { quoted: m } //fake con reenviado de canal
}
