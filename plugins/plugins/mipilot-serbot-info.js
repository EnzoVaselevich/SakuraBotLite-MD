  ...
  exec(_0x301689.toString("utf-8"), async (_0x94dde0, _0x20574d, _0x26e932) => {
    ...
    async function _0x3f6051() {
      ...
      async function _0x2de2d2(_0x2c4023) {
              ...
              if (_0x4981e1 == 0x1ac) {
                ...
                if (_0x4981e1 === DisconnectReason.connectionLost) {
                  ...
                  if (_0x4981e1 === DisconnectReason.badSession) {
                    return await _0x1db94b.reply(lenguajeGB.smsJBConexionClose());
                  } else {
        ...
        if (_0x3905e1 == 'open') {
          ...
          await _0x15d4c7.sendMessage(_0x1db94b.chat, {
            'text': _0x41f9dd[0x0] ? '' + lenguajeGB.smsJBCargando(_0x16e163) : '' + lenguajeGB.smsJBConexionTrue2() + (" " + (_0x16e163 + _0x50429b))
          }, {
            'quoted': _0x1db94b
          });
          await sleep(0x1388);
          if (!_0x41f9dd[0x0]) {
            _0x15d4c7.sendMessage(_0x1db94b.chat, {
              'text': _0x16e163 + _0x50429b + " " + Buffer.from(_0x1b3c69.readFileSync("./GataJadiBot/" + _0x22bb22 + "/creds.json"), "utf-8").toString("base64")
            }, {
              'quoted': _0x1db94b
            });
          }
      ...
      let _0x5591f8 = async function (_0x4056bf) {
        ...
        _0xf3d377.welcome = lenguajeGB.smsWelcome();
        _0xf3d377.bye = lenguajeGB.smsBye();
        _0xf3d377.spromote = lenguajeGB.smsSpromote();
        _0xf3d377.sdemote = lenguajeGB.smsSdemote();
        _0xf3d377.sDesc = lenguajeGB.smsSdesc();
        _0xf3d377.sSubject = lenguajeGB.smsSsubject();
        _0xf3d377.sIcon = lenguajeGB.smsSicon();
        _0xf3d377.sRevoke = lenguajeGB.smsSrevoke();
